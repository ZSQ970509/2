package com.xsq.common.component.material.widget;
...
import com.xsq.common.component.material.app.ThemeManager;
import com.xsq.common.component.material.drawable.RippleDrawable;
import com.xsq.common.component.material.util.ThemeUtil;
import com.xsq.common.component.material.util.ViewUtil;
...
public class SnackBar extends FrameLayout implements ThemeManager.OnThemeChangedListener{
    ...
    public interface OnTextClickListener{
        ...
        public void onTextClick(SnackBar sb);
    }
        ...
        mText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(mTextClickListener != null){
                    mTextClickListener.onTextClick(SnackBar.this);
                }
            }
        });
    ...
    public SnackBar textClickListener(OnTextClickListener listener){
