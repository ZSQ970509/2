...
public class ActionAdapter extends BaseAdapter {
    ...
    public ActionAdapter(Context context, List<Apply> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.numberTv = (TextView) convertView.findViewById(R.id.action_item_number);
            holder.areaTv = (TextView) convertView.findViewById(R.id.action_item_area);
            holder.operatorTv = (TextView) convertView.findViewById(R.id.action_item_operator);
            holder.timeTv = (TextView) convertView.findViewById(R.id.action_item_time);
