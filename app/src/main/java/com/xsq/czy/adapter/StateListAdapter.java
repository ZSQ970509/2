...
public class StateListAdapter extends BaseAdapter {
    ...
    public StateListAdapter(Context context, List<Device> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.old_state_item, null);
            holder.numberTv = (TextView) convertView.findViewById(R.id.old_state_item_number);
            holder.areaTv = (TextView) convertView.findViewById(R.id.old_state_item_area);
            holder.operatorTv = (TextView) convertView.findViewById(R.id.old_state_item_operator);
            holder.stateTv = (TextView) convertView.findViewById(R.id.old_state_item_state_img);
